...
// Session reguler wajib
if (!isset($_SESSION['reguler'])) {
    header("Location: step6_finalisasi.php");
    exit;
}
...
// Hapus session reguler
unset($_SESSION['reguler']);
unset($_SESSION['reguler_final']);
