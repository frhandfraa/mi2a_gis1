...
if (
    ...
    !isset($_SESSION['reguler']['pilihan_jurusan']) ||
    !isset($_SESSION['reguler']['jarak']['jarak1'])
) {
...
/* ================= DATA SESSION ================= */
$nilaiSession = $_SESSION['reguler']['nilai'] ?? [];
...
<h4 class="fw-bold mb-3">4️⃣ Input Nilai Rapor & Ijazah (Reguler)</h4>
