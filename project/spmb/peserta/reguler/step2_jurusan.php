...
/* Pastikan step1_reguler sudah diisi */
if (!isset($_SESSION['reguler']['sekolah'])) {
    header("Location: step1_sekolah_reguler.php");
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $_SESSION['reguler']['pilihan_jurusan'] = [
        'pilihan1' => [
...
<h4 class="mb-4">2️⃣ Pilihan Sekolah & Jurusan (Jalur Reguler)</h4>
