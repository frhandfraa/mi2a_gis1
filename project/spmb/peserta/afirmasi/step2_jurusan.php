...
// Pastikan step 2 sudah diisi
if (!isset($_SESSION['afirmasi']['jenis'])) {
    header("Location: step2_jenis.php");
    exit;
}

// Simpan pilihan jurusan dan lanjut ke step 4
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $_SESSION['afirmasi']['pilihan_jurusan'] = [
        'pilihan1' => [
...
<h4 class="mb-4">3️⃣ Pilihan Jurusan</h4>
...
<form method="post">
    ...
    <div class="d-flex justify-content-between mt-4">
        <a href="step2_jenis.php" class="btn btn-outline-secondary">⬅ Kembali</a>
    ...
    if(sekolahId){
        $.ajax({
            ...
            success: function(data){
                console.log("Data jurusan:", data); // debug
