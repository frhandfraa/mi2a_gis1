...
/* ================== VALIDASI STEP 2 ================== */
if (!isset($_SESSION['zonasi']['pilihan_jurusan'])) {
...
$pilihan1 = $_SESSION['zonasi']['pilihan_jurusan']['pilihan1'] ?? null;
$pilihan2 = $_SESSION['zonasi']['pilihan_jurusan']['pilihan2'] ?? null;
