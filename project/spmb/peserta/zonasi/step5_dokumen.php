...
/* ================= VALIDASI ALUR ZONASI ================= */
if (
    !isset($_SESSION['user_id']) ||
    !isset($_SESSION['zonasi']['nilai'])
) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach ($dokumenFiles as $fileKey) {
        if (!empty($_FILES[$fileKey]['name']) && $_FILES[$fileKey]['error'] === 0) {
            ...
            $_SESSION['zonasi']['dokumen'][$fileKey] = $fileName;
        }
    }
...
<h4 class="fw-bold">5️⃣ Upload Dokumen Pendukung (Zonasi)</h4>
