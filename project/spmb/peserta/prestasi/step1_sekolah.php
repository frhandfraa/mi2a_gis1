...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Set session agar step2 Prestasi bisa diakses
    $_SESSION['prestasi']['sekolah'] = $id_user;

    header("Location: step2_jurusan.php"); // step2 khusus Prestasi
    exit;
}
?>
...
<div class="container mt-4">
    <div class="card shadow-lg border-0 rounded-4">
        <div class="card-body p-4">
            <h4 class="fw-bold mb-4">1️⃣ Data Sekolah Asal (Prestasi)</h4>
